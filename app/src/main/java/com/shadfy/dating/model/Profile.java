package com.shadfy.dating.model;
...
public class Profile extends Application implements Constants, Parcelable {
    ...
    public Profile(JSONObject jsonData) {
        ...
        try {
            ...
            if (!jsonData.getBoolean("error")) {
                ...
                if (jsonData.has("photoModerateUrl")) {

                    this.setPhotoModerateUrl(jsonData.getString("photoModerateUrl"));
                }

                if (jsonData.has("coverModerateUrl")) {

                    this.setCoverModerateUrl(jsonData.getString("coverModerateUrl"));
                }
            }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.photoModerateUrl);
        dest.writeString(this.coverModerateUrl);
    }
    ...
    protected Profile(Parcel in) {
        ...
        this.photoModerateUrl = in.readString();
        this.coverModerateUrl = in.readString();
    }
