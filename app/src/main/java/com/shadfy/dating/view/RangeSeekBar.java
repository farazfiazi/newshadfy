...
package com.shadfy.dating.view;
...
import com.shadfy.dating.util.BitmapUtil;
import com.shadfy.dating.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showLabels) {
            ...
            String minLabel = getContext().getString(R.string.rsb_min_label);
            String maxLabel = getContext().getString(R.string.rsb_max_label);
