...
public class MenuFragment extends Fragment implements Constants {
    ...
    public void updateView() {
        ...
        if (App.getInstance().getCoverModerateUrl() != null && App.getInstance().getCoverModerateUrl().length() > 0) {

            imageLoader.get(App.getInstance().getCoverModerateUrl(), ImageLoader.getImageListener(mProfileCover, R.drawable.profile_default_cover, R.drawable.profile_default_cover));
        ...
        if (App.getInstance().getPhotoModerateUrl() != null && App.getInstance().getPhotoModerateUrl().length() > 0) {

            imageLoader.get(App.getInstance().getPhotoModerateUrl(), ImageLoader.getImageListener(mProfilePhoto, R.drawable.profile_default_photo, R.drawable.profile_default_photo));
