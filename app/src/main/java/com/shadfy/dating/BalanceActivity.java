...
import com.shadfy.dating.util.IabHelper;
import com.shadfy.dating.util.IabResult;
import com.shadfy.dating.util.Inventory;
import com.shadfy.dating.util.Purchase;
...
public class BalanceActivity extends ActivityBase implements RewardedVideoAdListener {
    ...
    private static final String TAG = "shadfy.inappbilling";            // Here you can write anything you like! For example: obama.white.house.billing
    private static final String TOKEN = "shadfy.inappbilling";          // Here you can write anything you like! For example: obama.white.house.billing

    // See documentation!

    static final String ITEM_SKU_1 = " shadfy.website.iap1";           // Change to: yourdomain.com.iap1
    static final String ITEM_SKU_2 = " shadfy.website.iap2";            // Change to: yourdomain.com.iap2
    static final String ITEM_SKU_3 = " shadfy.website.iap3";            // Change to: yourdomain.com.iap3
