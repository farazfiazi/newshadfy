package com.shadfy.dating.constants;
...
public interface Constants {
    ...
    public static final Boolean ADMOB_BANNER_IN_GALLERY_ITEM_VIEW = true; // false = Do not show google admob in section Gallery Item view

    public static final int VIDEO_FILE_MAX_SIZE = 7340035; //Max size for video file in bytes | For example 5mb = 5*1024*1024

    public static final String WEB_SITE = "https://shadfy.website/";  //web site url address
    ...
    public static final String BILLING_KEY = "";
    ...
    public static final String API_DOMAIN = "https://shadfy.website/";  //url address to which the application sends requests
    ...
    public static final String METHOD_ACCOUNT_UPLOAD_IMAGE = API_DOMAIN + "api/" + API_VERSION + "/method/profile.uploadImg" + API_FILE_EXTENSION;
