...
import com.shadfy.dating.adapter.AdvancedPeopleListAdapter;
...
public class MatchesFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void getItems() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_MATCHES_GET, null,
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                if (itemId == 0) {
                                    ...
                                    App.getInstance().setNewMatchesCount(0);
                                }
                                ...
                                if (response.has("items")) {
                                    ...
                                    if (arrayLength > 0) {
                                        ...
                                        for (int i = 0; i < usersArray.length(); i++) {
                                            ...
                                            Profile u_user = new Profile(userObj);

                                            itemsList.add(u_user);
                                        }
                                    }
                                }
