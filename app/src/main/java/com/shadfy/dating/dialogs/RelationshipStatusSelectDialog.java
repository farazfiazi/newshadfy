...
public class RelationshipStatusSelectDialog extends DialogFragment implements Constants {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] relationship_status_strings = new String[] {
                ...
                getText(R.string.relationship_status_5).toString(),
                getText(R.string.relationship_status_6).toString(),
                getText(R.string.relationship_status_7).toString(),
        ...
        b.setTitle(getText(R.string.account_relationship_status));
